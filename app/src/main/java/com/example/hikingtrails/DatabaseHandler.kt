...
//        fun insertData(name: String, description: String, imagePath: ByteArray?) {
...
//        }
    ...
    private fun createBaseTable(db: SQLiteDatabase?) {
        val CREATE_TABLE = ("CREATE TABLE IF NOT EXISTS $TABLE_NAME ("
                ...
                + "$KEY_IMAGE TEXT)") // Assuming this is the new column name
